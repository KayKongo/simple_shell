 ...
 *
 * Return: The number of bytes in the initial segment of str1 which are part of str2.
 */
...
/**
 * _strcspn - Compute the segment of str1 which consists of characters not in str2.
 * @str1: The string to be searched.
 * @str2: The string to be used.
 *
